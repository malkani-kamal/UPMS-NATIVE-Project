...
export CC_CHANNEL_ID="transportchannel"
...
case $OPERATION in
    ...
    "instantiate")
              ...
              #peer chaincode list --instantiated -C transportchannel
        ;;
    "query")
            echo -n "query a="
    ...
    "invokeB")
            echo "Invoke sending 5 token from a=>b"
            peer chaincode invoke -C $CC_CHANNEL_ID -n $CC_NAME  -c '{"Args":["invoke","b","a","5"]}'
        ;;
    "clear")
